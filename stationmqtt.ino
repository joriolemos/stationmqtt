...
const char* ssid = "#FORABOLSONARO";  // Enter SSID here
const char* password = "lula13em2022";  //Enter Password here
WebServer server(80);

/* Parte de envio de dados*/
...
String SendHTML(float temperature, float humidity, float pressure, float altitude) {
  ...
  ptr += "<h3>Elen e Jorio Enterprises</h3>";
